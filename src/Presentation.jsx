...
const Presentation = () => {
    ...
    <div key="slide1" style={styles.slide}>
      <div style={styles.centerText}>
        <h1 style={styles.title}>
          A RANDOMIZED CONTROLLED TRIAL TO EVALUATE THE EFFECTIVENESS OF ONLAY
          AND SUBLAY MESH REPAIR IN THE TREATMENT OF VENTRAL HERNIA
        </h1>
      </div>
      <div style={{ ...styles.centerText, marginBottom: "32px" }}>
        <p style={{ marginBottom: "16px" }}>
          <span style={styles.bold}>Principal Investigator:</span> Dr. U.
          Kavitha, Post Graduate, Department of General Surgery, AVMCH
        </p>
        <p style={{ marginBottom: "16px" }}>
          <span style={styles.bold}>Guide:</span> Dr. T. Ramachandrudu, MS MCh,
          Professor & HOD
        </p>
        <p style={{ marginBottom: "16px" }}>
          <span style={styles.bold}>Co-Guide:</span> Dr. A. Akmal, MS, Associate
          Professor
        </p>
        <p>
          <span style={styles.bold}>Department:</span> General Surgery, AVMCH,
          Puducherry
        </p>
      </div>
  ...
  <div style={{ marginBottom: "24px" }}>
    <div style={styles.card}>
      <h3 style={styles.subtitle}>HEAD OF DEPARTMENT:</h3>
      <ul style={styles.list}>
        <li style={styles.listItem}>DR. RAVICHANDRAN.K</li>
        <li style={styles.listItem}>PROFESSOR & HOD</li>
        <li style={styles.listItem}>DEPT. OF GENERAL SURGERY</li>
        <li style={styles.listItem}>AVMCH.</li>
      </ul>
    </div>

    <div style={styles.card}>
      <h3 style={styles.subtitle}>GUIDE: Dr. T. RAMACHANDRUDU MS MCH PLASTIC SURGERY</h3>
      <ul style={styles.list}>
        <li style={styles.listItem}>Unit Chief and Professor of Department of General Surgery</li>
        <li style={styles.listItem}>Aarupadai Veedu Medical College and Hospital, Puducherry</li>
        <li style={styles.listItem}>Contact: 8608702876</li>
        <li style={styles.listItem}>Email: ramachandrvudu.subramanian@avmc.edu.in</li>
      </ul>
    </div>
  </div>
</div>,
  ...
  <div style={{ marginBottom: "24px" }}>
    <div style={styles.card}>
      <h3 style={styles.subtitle}>NAME OF THE CO-GUIDE: Dr. A. AKMAL MS</h3>
      <ul style={styles.list}>
        <li style={styles.listItem}>Associate Professor, Department of General Surgery</li>
        <li style={styles.listItem}>Aarupadai Veedu Medical College and Hospital, Puducherry</li>
        <li style={styles.listItem}>Contact: 8939932440</li>
        <li style={styles.listItem}>Email: aakmal04@gmail.com</li>
      </ul>
    </div>

    <div style={styles.card}>
      <h3 style={styles.subtitle}>NAME OF THE PG: Dr. Kavitha U</h3>
      <ul style={styles.list}>
        <li style={styles.listItem}>Post Graduate, Dept of General Surgery</li>
        <li style={styles.listItem}>AVMC&H, Puducherry</li>
      </ul>
    </div>
  </div>
</div>,
    ...
    <div key="slide4" style={styles.slide}>
      ...
      <div style={{ ...styles.card, marginBottom: "24px" }}>
        ...
        <p>
          To evaluate the effectiveness of onlay and sublay mesh repair in the
      ...
      <div style={styles.card}>
        ...
        <ul style={styles.list}>
          <li style={styles.listItem}>
            To compare duration of surgery between techniques
          </li>
          <li style={styles.listItem}>
            To evaluate early postoperative complications:
          ...
          <li style={styles.listItem}>
            To assess patient-reported outcomes (pain scores, quality of life)
          </li>
        </ul>
      </div>
    </div>,
    ...
    <div key="slide5" style={styles.slide}>
      ...
      <div style={styles.grid}>
        <div style={styles.card}>
          <p>
            <span style={styles.bold}>Study Design:</span> Randomized Controlled
            Trial
          </p>
        </div>
        ...
        <div style={styles.card}>
          <p>
            <span style={styles.bold}>Study Duration:</span> 18 months
          </p>
        </div>

        <div style={styles.card}>
          <p>
            <span style={styles.bold}>Study Site:</span> Department of General
            Surgery, AVMCH, Puducherry
          </p>
        </div>

        <div style={styles.card}>
          <p>
            <span style={styles.bold}>Ethics Approval:</span> IHEC, AVMCH
          </p>
        </div>
      </div>
      ...
      >
        <h3 style={{ ...styles.subtitle, ...styles.centerText }}>
        ...
        <div style={{ ...styles.grid, marginTop: "12px" }}>
          ...
          >
            <p style={{ ...styles.bold, marginBottom: "4px" }}>
              Group 1: 40 patients
            </p>
      ...
      <div>
        <div style={{ ...styles.card, marginBottom: "12px" }}>
          ...
          <ul style={styles.list}>
            ...
            <li style={styles.listItem}>
              Baseline investigations (CBC, LFT, RFT, etc.)
            </li>
          </ul>
        </div>
        ...
        <div style={{ ...styles.card, marginBottom: "12px" }}>
          ...
          <ul style={styles.list}>
            ...
            <li style={styles.listItem}>
              Same surgeon performs both techniques
            </li>
            <li style={styles.listItem}>
              Standard mesh material and surgical approach
            </li>
          </ul>
        </div>
        ...
        <div style={styles.card}>
          ...
          <ul style={styles.list}>
            ...
            <li style={styles.listItem}>
              Postoperative complications (seroma, infection, flap necrosis)
            </li>
    ...
    <div key="slide8" style={styles.slide}>
      ...
      <div style={{ ...styles.card, marginBottom: "16px" }}>
        ...
        <ul style={styles.list}>
          <li style={styles.listItem}>
            Total sample size: 80 (40 in each group)
          </li>
          <li style={styles.listItem}>
            Calculated using formula for comparison of two independent
            proportions
          </li>
          <li style={styles.listItem}>
            Expected proportion of complications: 0.463 and 0.195
          </li>
      ...
      <div style={styles.card}>
        ...
        <ul style={styles.list}>
          ...
          <li style={styles.listItem}>
            Independent t-test for quantitative outcomes
          </li>
          <li style={styles.listItem}>
            Data visualization using appropriate diagrams
          </li>
          <li style={styles.listItem}>
    ...
    <div key="slide9" style={styles.slide}>
      ...
      <div style={styles.grid}>
        <div style={styles.card}>
          ...
          <ul style={styles.list}>
            ...
            <li style={styles.listItem}>
              Equipment for open ventral hernia repair
            </li>
      ...
      <div style={{ ...styles.card, marginTop: "16px" }}>
        ...
        <ul style={styles.list}>
          ...
          <li style={styles.listItem}>
            Institutional Research Committee support
          </li>
          <li style={styles.listItem}>Data collection and analysis tools</li>
          <li style={styles.listItem}>
            Documentation and record keeping facilities
          </li>
        </ul>
      </div>
    </div>,
    ...
    <div key="slide10" style={styles.slide}>
      ...
      >
        <h3 style={{ ...styles.subtitle, marginBottom: "8px" }}>
          Total Budget: 40,000 Rupees
        </h3>
      ...
      <div style={{ ...styles.card, marginTop: "24px" }}>
        ...
        <p style={{ marginBottom: "4px" }}>
          This is an intradepartmental study with no collaborating departments.
        </p>
        <p>
          The study involves minimal risk and no external funding is required.
        </p>
      </div>
    </div>,
    ...
    <div key="slide11" style={styles.slide}>
      ...
      <ol style={{ ...styles.list, listStyleType: "decimal" }}>
        <li style={{ ...styles.listItem, marginBottom: "16px" }}>
          Fitzgibbons Jr RJ, Forse RA. Groin hernias in adults. N Eng J Med.
          2015; 372(8): 756-63.
        </li>

        <li style={{ ...styles.listItem, marginBottom: "16px" }}>
          Saber A, et al. Onlay versus sublay mesh repair for ventral hernia. J
          Surg 2015; 4:1-4.
        </li>

        <li style={{ ...styles.listItem, marginBottom: "16px" }}>
          Kumar V, et al. A comparative analysis on various techniques of
          incisional hernia repair - experience from a tertiary care teaching
          hospital in South India. Indian J Surg 2013; 75:271-3.
        </li>

        <li style={{ ...styles.listItem, marginBottom: "16px" }}>
          Ibrahim R, et al. Is the surgical site infection rate higher in sublay
          or onlay mesh repair of incisional hernia? Ann Med Surg (Lond)
          2021;62:200-2.
        </li>

        <li style={{ ...styles.listItem, marginBottom: "16px" }}>
          Memon MR, et al. Results of stoppa's sublay mesh repair in incisional
          & ventral hernias. J Pak Med Assoc. 2010; 60:798-801.
        </li>
      </ol>
     
    </div>, 
    // Slide 12: Justification for Study Title
    <div key="slide12" style={styles.slide}>
    <h2 style={styles.title}>JUSTIFICATION FOR STUDY TITLE</h2>

    <ul style={{ ...styles.list, marginBottom: "16px" }}>
      <li style={{ ...styles.listItem, marginBottom: "12px" }}>
        <span style={styles.bold}>IHEC Approval:</span> The study protocol
        has been approved by the Institutional Human Ethical Committee
        (IHEC) with approval number AV/IHEC/01/2024/058.
      </li>

      <li style={{ ...styles.listItem, marginBottom: "12px" }}>
        <span style={styles.bold}>Specific Objectives:</span> The study aims
        to evaluate the effectiveness of onlay and sublay mesh repair in
        ventral hernia treatment, which is a specific and well-defined
        research question.
      </li>

      <li style={{ ...styles.listItem, marginBottom: "12px" }}>
        <span style={styles.bold}>Randomized Control Trial Design:</span>{" "}
        The study's randomized control trial design will provide
        high-quality evidence on the effectiveness of onlay and sublay mesh
        repair.
      </li>

      <li style={{ ...styles.listItem, marginBottom: "12px" }}>
        <span style={styles.bold}>Contribution to Existing Knowledge:</span>{" "}
        The study's findings will contribute to the existing body of
        knowledge on hernia repair and have implications for clinical
        practice and patient outcomes.
      </li>

      <li style={{ ...styles.listItem }}>
        <span style={styles.bold}>No Intent to Plagiarize:</span> There was
        no intent to plagiarize or duplicate existing research. The study
        title accurately reflects the study's objectives and methodologies.
      </li>
    </ul>

    <div style={{ ...styles.card, marginTop: "16px" }}>
      <p style={styles.bold}>Conclusion:</p>
      <p>
        The study title accurately reflects the study's objectives and
        methodologies, and the justifications address the concerns regarding
        plagiarism.
      </p>
      <a href="https://pubmed.ncbi.nlm.nih.gov/37195549/">https://pubmed.ncbi.nlm.nih.gov/37195549/</a>
    </div>
  </div>
  ];
...
//             Principal Investigator: Dr. U. Kavitha
//           </h3>
//           <ul style={styles.list}>
//             <li style={styles.listItem}>Post Graduate in MS General Surgery</li>
//             <li style={styles.listItem}>
//               Department of General Surgery, AVMCH
//             </li>
//           </ul>
//         </div>
...
//       <ul style={styles.list}>
//         <li style={styles.listItem}>
//           Ventral hernias account for 15-18% of all surgical procedures
//         </li>
//         <li style={styles.listItem}>
//           Incisional hernias: most common long-term complication (3-13%, up to
//           23%)
//         </li>
//         <li style={styles.listItem}>Primary suture repair: high recurrence</li>
//         <li style={styles.listItem}>
//           Mesh repairs: gold standard with increased understanding of abdominal
//           wall anatomy
//         </li>
//         <li style={styles.listItem}>
...
//           <ul style={styles.nestedList}>
//             <li style={styles.listItem}>
//               Onlay: mesh placed over rectus sheath
//             </li>
//             <li style={styles.listItem}>Sublay: preperitoneal mesh repair</li>
//           </ul>
//         </li>
//         <li style={styles.listItem}>
//           Need for direct comparison to determine optimal technique
//         </li>
//       </ul>
...
//       >
//         <div style={styles.card}>
//           <p style={{ ...styles.bold, marginBottom: "8px" }}>
//             Several studies show different complication rates:
//           </p>
//           <p style={{ marginBottom: "4px" }}>
//             Seroma: 6% onlay vs 2% sublay (Saber et al.)
//           </p>
//           <p style={{ marginBottom: "4px" }}>
//             Wound infection: 13.33% onlay vs 11.11% sublay (Kumar et al.)
//           </p>
